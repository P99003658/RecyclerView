...
class MainActivity : AppCompatActivity() {
    ...
    myDataList.add(UserData("Pankaj","pankaj@gmail.com","9632587410"))
    myDataList.add(UserData("kumar","kumar@gmail.com","7548123690"))
    myDataList.add(UserData("Khanith","Khanith@gmail.com","9458712369"))
    myDataList.add(UserData("sai","sai@gmail.com","7541236987"))
    myDataList.add(UserData("Vishal","vishal@gmail.com","9874563210"))
    myDataList.add(UserData("roshan","roshan@gmail.com","7896541245"))
    myDataList.add(UserData("Ganeshreddy","ganeshreddy@gmail.com","8745963210"))
    myDataList.add(UserData("teja","teja@gmail.com","9745812360"))
